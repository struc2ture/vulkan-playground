...
{
    VkShaderModule vert_shader = create_shader_module("bin/shaders/tri.vert.spv", device);
    VkShaderModule frag_shader = create_shader_module("bin/shaders/tri.frag.spv", device);
